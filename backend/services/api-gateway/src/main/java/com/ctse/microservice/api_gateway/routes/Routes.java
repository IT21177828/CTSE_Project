package com.ctse.microservice.api_gateway.routes;
...
import com.ctse.microservice.api_gateway.tracing.TracingFilter;
...
public class Routes {
    ...
    public Routes(TracingFilter tracingFilter) {
